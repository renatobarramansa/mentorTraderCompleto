...
export class ChatService {
  ...
  async processMessage(
    ...
    try {
      const response = await this.anthropicService.generateResponse(anthropicRequest);
      return response;
    } catch (error) {
...
Conversando com ${name}, ${levelDescription}.
...
Lembre-se: você está ajudando um ${levelDescription} que está aprendendo NTSL.
